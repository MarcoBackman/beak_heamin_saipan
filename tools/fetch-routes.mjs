...
const P = {
  ...
  SMILING_COVE:[15.2170, 145.7244],
  MOBIL_GARAPAN:[15.2049,145.7170],
  ROTA_AIRPORT:[14.1743, 145.2425],
  CORAL_GARDEN:[14.1367, 145.1408],
...
const LEGS = [
  ...
  ['KENSINGTON','SMILING_COVE'],
  ['SMILING_COVE','KENSINGTON'],
  ['ILOVESAIPAN','MOBIL_GARAPAN'],
  ['MOBIL_GARAPAN','GARAPAN'],
  ['GARAPAN','KENSINGTON'],
];
