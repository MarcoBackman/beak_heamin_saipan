...
window.SAIPAN = (function(){
  ...
  const DETAILS = {
    ...
    6: {
      ...
      tips: [
        ...
        '이동은 컨시어지에 셔틀 문의 — 코럴 오션은 무료 지역 셔틀 어메니티가 있으나 일반 라운딩 상품은 픽업 불포함(개별 이동)이 기본. 셔틀이 안 되면 렌터카 또는 택시 왕복 약 $90',
      ],
    },
    7: {
      todo: [
  ...
  return { SPOTS, POIS, REFS, SHORTS, DAYS, DETAILS, TRIP, WX_FALLBACK };
})();
