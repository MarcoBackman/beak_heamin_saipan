  ...
  const DETAILS = {
    ...
    6: {
      todo: [
        ...
        { t:'07:30', x:'⛳ 18홀 티오프 — 예약 확인서 지참 (어메니티 적용)' },
        { t:'낮',    x:'클럽하우스 점심 — 컨디션 되면 추가 9홀' },
        { t:'늦은 오후', x:'호텔 복귀 — 인피니티 풀·스파로 라운딩 피로 풀기' },
        { t:'저녁',  x:'호텔 레스토랑 디너' },
      ],
      bring: [
        '골프웨어·모자', '골프화 (또는 렌탈 사전 확인)', '골프장갑',
        '볼·티 여유분', '자외선 토시·선크림', '물·이온음료',
        '골프 어메니티 예약 확인서', '팁·간식용 소액 현금', '여벌 셔츠 (땀 대비)',
      ],
      tips: [
        '9월 사이판 한낮은 체감 35°C — 이른 티오프가 답, 홀마다 수분 보충',
        '오션프런트 홀은 바닷바람이 한 클럽 이상 좌우함 — 클럽 선택 여유 있게',
        '볼 로스트 각오 — 여유분 넉넉히 (프로샵 볼은 비쌈)',
        '어메니티 적용 범위(그린피·카트·클럽 렌탈)는 체크인 때 예약 확인서로 재확인',
      ],
    },
    7: {
      todo: [
