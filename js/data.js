...
window.SAIPAN = (function(){
  ...
  const POIS = [
    ...
    { cat:"stay", nm:"로타 숙소 (송송)", en:"Rota / Songsong", ll:[14.1367,145.1408],
      note:"로타 1박 · 송송 빌리지 (Day 3 체크인)" },
  ...
  const DAYS = [
    ...
    { label:'Day 3 · 9/12 토', title:'로타 이동 · 로타 홀 빛내림',
      stops:[
        ...
        {n:'사이판 공항 · 공영주차 (1박 최대 $20)', ll:SPN_AIRPORT, mode:'drive'},
    ...
    { label:'Day 4 · 9/13 일', title:'테테토 · 스위밍 홀 → 복귀',
      stops:[
        ...
        {n:'사이판 공항 · 주차장에서 렌터카 회수', ll:SPN_AIRPORT, mode:'fly', min:30},
  ...
  const DETAILS = {
    ...
    3: {
      todo: [
        { t:'09:00', x:'로타 짐 최종 점검 — 위탁 20lb+휴대 10lb, 캐리어·롱핀·대여 웨이트·부이는 방에 그대로' },
        { t:'10:00', x:'렌터카로 사이판 공항 이동 (약 30~35분), 귀중품 없이 공영주차장에 1박 주차' },
    ...
    4: {
      todo: [
        ...
        { t:'오후',  x:'로타 렌터카 반납 → 로타 공항 → 사이판 복귀, 공영주차장에서 Enterprise 차량 회수' },
